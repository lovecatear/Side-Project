...
function canvasnow() {
    ...
    if (maze[yourhero.body.x][yourhero.body.y] == 2) { alert('Goal !'); clearInterval(gameInterval); return 1; }
...
function autogo() {
    ...
    if (maze[(yourhero.body.x) + 1][yourhero.body.y] == 2) {
        (yourhero.body.x)++; canvasnow(); return 1;
    }
    if (maze[(yourhero.body.x) - 1][yourhero.body.y] == 2) {
        (yourhero.body.x)--; canvasnow(); return 1;
    }
    if (maze[yourhero.body.x][(yourhero.body.y) + 1] == 2) {
        (yourhero.body.y)++; canvasnow(); return 1;
    }
    if (maze[yourhero.body.x][(yourhero.body.y) - 1] == 2) {
        (yourhero.body.y)--; canvasnow(); return 1;
    }
    ...
    if (maze[(yourhero.body.x) + 1][yourhero.body.y] == 0) {
        maze[yourhero.body.x][yourhero.body.y] = 6; (yourhero.body.x)++; pcgogo.push([yourhero.body.x, yourhero.body.y]); return 1;
    }
    if (maze[(yourhero.body.x) - 1][yourhero.body.y] == 0) {
        maze[yourhero.body.x][yourhero.body.y] = 6; (yourhero.body.x)--; pcgogo.push([yourhero.body.x, yourhero.body.y]); return 1;
    }
    if (maze[yourhero.body.x][(yourhero.body.y) + 1] == 0) {
        maze[yourhero.body.x][yourhero.body.y] = 6; (yourhero.body.y)++; pcgogo.push([yourhero.body.x, yourhero.body.y]); return 1;
    }
    if (maze[(yourhero.body.x)][(yourhero.body.y) - 1] == 0) {
        maze[yourhero.body.x][yourhero.body.y] = 6; (yourhero.body.y)--; pcgogo.push([yourhero.body.x, yourhero.body.y]); return 1;
    }
    ...
    if (maze[(yourhero.body.x) + 1][yourhero.body.y] == 6) {
        maze[yourhero.body.x][yourhero.body.y] = 5; (yourhero.body.x)++; pcgogo.pop([yourhero.body.x, yourhero.body.y]); return 1;
    }
    if (maze[(yourhero.body.x) - 1][yourhero.body.y] == 6) {
        maze[yourhero.body.x][yourhero.body.y] = 5; (yourhero.body.x)--; pcgogo.pop([yourhero.body.x, yourhero.body.y]); return 1;
    }
    if (maze[yourhero.body.x][(yourhero.body.y) + 1] == 6) {
        maze[yourhero.body.x][yourhero.body.y] = 5; (yourhero.body.y)++; pcgogo.pop([yourhero.body.x, yourhero.body.y]); return 1;
    }
    if (maze[(yourhero.body.x)][(yourhero.body.y) - 1] == 6) {
        maze[yourhero.body.x][yourhero.body.y] = 5; (yourhero.body.y)--; pcgogo.pop([yourhero.body.x, yourhero.body.y]); return 1;
    }
...
function pcgogoauto() {
    ...
    gameInterval = setInterval(autogo, 10);
}
